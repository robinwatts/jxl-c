...
jxl_status_t jxl_modular_decode_frame_lf_groups(jxl_context *ctx, jxl_context *alloc, const jxl_frame *frame,
...
jxl_status_t jxl_modular_decode_frame_group_coefficients(
    jxl_context *ctx, jxl_context *alloc, const jxl_frame *frame, const jxl_parsed_image_header *parsed,
