...
jxl_status jxl_learn_tree(const jxl_image *images, const jxl_modular_options *opts,
                 uint32_t start, uint32_t stop,
                 const jxl_array_modular_multiplier_info *multiplier_info,
                 jxl_tree *out);

// Default single-image compress.
jxl_status jxl_modular_generic_compress(const jxl_image *image, const jxl_modular_options *opts,
                              jxl_bit_writer *writer, jxl_layer_type layer);

// For encoding with a given tree.
jxl_status jxl_modular_compress(const jxl_image *image, const jxl_modular_options *opts,
