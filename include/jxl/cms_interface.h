 ...
 * pixels to transform per call to @ref jxl_cms_interface::run. @p init_data comes
 * directly from the @ref jxl_cms_interface instance. Since @c run only receives
 ...
 */
typedef void* (*jxl_cms_init_func)(void* init_data, size_t num_threads,
                                      size_t pixels_per_thread,
                                      const jxl_color_profile* input_profile,
                                      const jxl_color_profile* output_profile,
 ...
 */
typedef float* (*jxl_cms_get_buffer_func)(void* user_data, size_t thread);
 ...
 */
typedef JXL_BOOL (*jxl_cms_run_func)(void* user_data, size_t thread,
 ...
 * data.
 */
typedef void (*jxl_cms_destroy_func)(void*);
...
typedef struct {
   ...
   * jxl_cms_init_func. */
  jxl_cms_init_func init;
  /** Returns a buffer that can be used as input to @c run. */
  jxl_cms_get_buffer_func get_src_buf;
  /** Returns a buffer that can be used as output from @c run. */
  jxl_cms_get_buffer_func get_dst_buf;
  /** Executes the transform on a batch of pixels, per @ref jxl_cms_run_func.
   */
  jxl_cms_run_func run;
  /** Cleans up the transform. */
  jxl_cms_destroy_func destroy;
} jxl_cms_interface;
